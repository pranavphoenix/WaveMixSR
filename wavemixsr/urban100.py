...
dataset_urban100      = load_dataset('eugenesiow/Urban100', 'bicubic_x'+str(args.resolution), split='validation', cache_dir = '/workspace/')
...
print(len(trainset))
testset = SuperResolutionTestDataset(dataset_urban100)
print(len(testset))
...
PATH = 'urban100_'+str(args.resolution)+'x_y_'+str(args.eval_metric)+'.pth'
