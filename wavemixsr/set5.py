...
dataset_set5      = load_dataset('eugenesiow/Set5', 'bicubic_x'+str(args.resolution), split='validation', cache_dir = '/workspace/')
...
print(len(trainset))
testset = SuperResolutionTestDataset(dataset_set5)
print(len(testset))
...
PATH = 'set5_'+str(args.resolution)+'x_y_'+str(args.eval_metric)+'.pth'
